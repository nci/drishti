...
**
** Created: Mon Nov 18 14:44:25 2013
...
static const char qt_meta_stringdata_GradientEditorWidget[] = {
    ...
    "applyUndo(bool)\0setColorGradient(QGradientStops)\0"
...
void GradientEditorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->applyUndo((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->setColorGradient((*reinterpret_cast< QGradientStops(*)>(_a[1]))); break;
        case 3: _t->setGeneralLock((*reinterpret_cast< GradientEditor::LockType(*)>(_a[1]))); break;
        case 4: _t->setDrawBox((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->updateColorGradient(); break;
        default: ;
        }
    }
}
...
// SIGNAL 1
void GradientEditorWidget::applyUndo(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
