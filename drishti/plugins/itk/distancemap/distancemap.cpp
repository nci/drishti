...
QStringList
DistanceMap::registerPlugin()
{
  QStringList regString;

  regString << "Signed Distance Map";
...
void DistanceMap::setPvlFileManager(VolumeFileManager *p) { m_pvlFileManager = p; }
void DistanceMap::setLodFileManager(VolumeFileManager *l) { m_lodFileManager = l; }
void DistanceMap::setClipInfo(QList<Vec> cp, QList<Vec> cn) { m_clipPos = cp; m_clipNormal = cn; }
void DistanceMap::setCropInfo(QList<CropObject> c) { m_crops = c; }
void DistanceMap::setSamplingLevel(int s) { m_samplingLevel = s; }
void DistanceMap::setDataLimits(Vec dmin, Vec dmax) { m_dataMin = dmin; m_dataMax = dmax; }
void DistanceMap::setVoxelScaling(Vec v) { m_voxelScaling = v; }
void DistanceMap::setPreviousDirectory(QString d) { m_previousDirectory = d; }
void DistanceMap::setLookupTable(int ls, QImage li) { m_lutSize = ls; m_lutImage = li; }

void DistanceMap::setPathInfo(QList<PathObject> c)
{
  m_paths.clear();
...
void
DistanceMap::setPruneData(int lod,
