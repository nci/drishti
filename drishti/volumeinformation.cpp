...
{  
  ...
  if (manifest.voxelType >= PvlManifestParser::UnsignedChar &&
  ...
  if (unit == "angstrom") pvlInfo.voxelUnit = Angstrom;
  else if (unit == "nanometer") pvlInfo.voxelUnit = Nanometer;
  else if (unit == "micron") pvlInfo.voxelUnit = Micron;
  else if (unit == "millimeter") pvlInfo.voxelUnit = Millimeter;
  else if (unit == "centimeter") pvlInfo.voxelUnit = Centimeter;
  else if (unit == "meter") pvlInfo.voxelUnit = Meter;
  else if (unit == "kilometer") pvlInfo.voxelUnit = Kilometer;
  else if (unit == "parsec") pvlInfo.voxelUnit = Parsec;
  else if (unit == "kiloparsec") pvlInfo.voxelUnit = Kiloparsec;
