...
//		   QFont("Helvetica", 10),
//		   QString("p:%1").arg(pos, 0, 'f', Global::floatPrecision()));
//      path.addText(valRect.x()+4,
//		   valRect.y()+valRect.height()-4,
//		   QFont("Helvetica", 10),
//		   QString("a:%1").arg(alpha, 0, 'f', Global::floatPrecision()));
//      p.setBrush(Qt::black);
...
GradientEditor::showHelp()
{
  ...
  vlist.clear();
  QFile helpFile(":/transferfunctioneditor.help"+Global::helpLanguage());
