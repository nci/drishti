...
LightingInformation::LightingInformation(const LightingInformation& li)
{
  ...
  softness = li.softness;
  edges = li.edges;
  shadowIntensity = li.shadowIntensity;
  valleyIntensity = li.valleyIntensity;
  peakIntensity = li.peakIntensity;
				 ...
				 float frc)
{
  ...
  lightInfo.softness = lightInfo1.softness + frc*(lightInfo2.softness -
						  lightInfo1.softness);

  lightInfo.edges = lightInfo1.edges + frc*(lightInfo2.edges -
					    lightInfo1.edges);

  lightInfo.shadowIntensity = lightInfo1.shadowIntensity + frc*(lightInfo2.shadowIntensity -
								lightInfo1.shadowIntensity);

  lightInfo.valleyIntensity = lightInfo1.valleyIntensity + frc*(lightInfo2.valleyIntensity -
								lightInfo1.valleyIntensity);

  lightInfo.peakIntensity = lightInfo1.peakIntensity + frc*(lightInfo2.peakIntensity -
							    lightInfo1.peakIntensity);
...
LightingInformation::load(fstream &fin)
{
  ...
  while(!done)
      ...
      else if (strcmp(keyword, "userlightvector") == 0)
	{
      ...
      else if (strcmp(keyword, "softness") == 0)
	fin.read((char*)&softness, sizeof(float));
      else if (strcmp(keyword, "edges") == 0)
	fin.read((char*)&edges, sizeof(float));
      else if (strcmp(keyword, "shadowintensity") == 0)
	fin.read((char*)&shadowIntensity, sizeof(float));
      else if (strcmp(keyword, "valleyintensity") == 0)
	fin.read((char*)&valleyIntensity, sizeof(float));
      else if (strcmp(keyword, "peakintensity") == 0)
	fin.read((char*)&peakIntensity, sizeof(float));
...
LightingInformation::save(fstream &fout)
{
  ...
  memset(keyword, 0, 100);
  sprintf(keyword, "softness");
  fout.write((char*)keyword, strlen(keyword)+1);
  fout.write((char*)&softness, sizeof(float));


  memset(keyword, 0, 100);
  sprintf(keyword, "edges");
  fout.write((char*)keyword, strlen(keyword)+1);
  fout.write((char*)&edges, sizeof(float));
  ...
  memset(keyword, 0, 100);
  sprintf(keyword, "valleyintensity");
  fout.write((char*)keyword, strlen(keyword)+1);
  fout.write((char*)&valleyIntensity, sizeof(float));


  memset(keyword, 0, 100);
  sprintf(keyword, "peakintensity");
  fout.write((char*)keyword, strlen(keyword)+1);
  fout.write((char*)&peakIntensity, sizeof(float));
