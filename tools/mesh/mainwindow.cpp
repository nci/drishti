...
void MainWindow::on_actionPointMode_triggered(bool checked) { m_Viewer->setPointMode(checked); }
void MainWindow::on_actionDistanceMode_triggered() { m_Viewer->measureLength(); }
...
MainWindow::on_actionClipping_triggered()
{
  ...
  propertyEditor.set("Clip Settings", plist, keys);
  propertyEditor.resize(200, 200);
