...
#define CONNECTVIEWER_H
  ...
  connect(m_viewer, SIGNAL(connectedComponentsPlus(Vec,Vec,int,int)),
	  this, SLOT(connectedComponentsPlus(Vec,Vec,int,int)));
  ...
  connect(m_viewer, SIGNAL(dilateAllTags(Vec,Vec,int)),
	  this, SLOT(dilateAllTags(Vec,Vec,int)));
...
connect(m_viewer, SIGNAL(poreId(Vec, Vec, int, int, int, int)),
	this, SLOT(poreId(Vec, Vec, int, int, int, int)));
