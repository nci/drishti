...
//////  MyBitArray *visibilityMap = VolumeOperations::getVisibilityMap();
//////  
//////  
...
//////
//////      if (visibilityMap->testBit(((qint64)d0)*m_width*m_height + w0*m_height + h0))
//////	{
//////	  for(qint64 dd=ds0; dd<=de0; dd++)
//////	    for(qint64 ww=ws0; ww<=we0; ww++)
//////	      for(qint64 hh=hs0; hh<=he0; hh++)
//////		{
//////		  if (Vec((dd-d0),(ww-w0),(hh-h0)).squaredNorm() < rad0*rad0)
//////		    {
//////		      bitmask.setBit((dd-ds)*dm2 + (ww-ws)*dm + (hh-hs),
//////				     visibilityMap->testBit(dd*m_width*m_height + ww*m_height + hh));
//////		    }
//////		}
//////	}
//////    } // seeds
